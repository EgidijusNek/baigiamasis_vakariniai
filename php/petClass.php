...
class Pet{
    ...
    public function createPet(){
        ...
        if ($_SERVER['REQUEST_METHOD']=='POST') {
            $sql="INSERT INTO pet (petName, petHappiness, petHunger, petHealth, petSleep, petState, image, age, weight, idUser) VALUES (:petName, 50, 50, 50, 50, 'normal', '$src', 0, 1, '$id')";
            $mysql=$this->mysql->prepare($sql);
            $mysql->bindValue(':petName', $_POST['petName'],PDO::PARAM_STR);
            try{
                $mysql->execute();
