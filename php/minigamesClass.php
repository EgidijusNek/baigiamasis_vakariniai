...
//daryta iki čia
    public function play($item, $petId){
        if(!empty($item)){
            ...
            if(($user_item == 'akmuo' && $comp_item == 'zirkles') ||
                ...
                echo "<script type='text/javascript'>alert('Você: $user_item \\nComputador: $comp_item \\nVocê venceu!');javascript:window.location='akmuo-popierius-zirkles.php?idP=$petId';</script>";
            }
            else if ($user_item == $comp_item){
                echo "<script type='text/javascript'>alert('Você: $user_item \\nComputador: $comp_item \\nEmpate!');javascript:window.location='akmuo-popierius-zirkles.php?idP=$petId';</script>";
            }
            else{
                echo "<script type='text/javascript'>alert('Você: $user_item \\nComputador: $comp_item \\nVocê perdeu!');javascript:window.location='akmuo-popierius-zirkles.php?idP=$petId';</script>";
            }

            echo $user_item;
            echo $comp_item;

            //echo '<br><br> <a class="btn btn-outline-success menu-nav" href=""./akmuo-popierius-zirkles.php"" role="button">play de Novo!</a>';
        }
        //else{
    ...
    public function playgammer($box, $petId){
        ...
        if($box[0] == 'x' && $box[1] == 'x' && $box[2] == 'x' ||
            ...
            echo "<script type='text/javascript'>alert('Você venceu!');javascript:window.location='Game-da-gammer.php?idP=$petId';</script>";
            $campeao = 'x';
            ...
            echo "<script type='text/javascript'>alert('O computador venceu!');javascript:window.location='Game-da-gammer.php?idP=$petId';</script>";
            $campeao = 'o';
        }
